...
// 新しいコントロールポイント
const cp = {}
cp.x = p1.x * 2 - (p0.x + p2.x) / 2; //★公式
cp.y = p1.y * 2 - (p0.y + p2.y) / 2; //★公式
const pFinal = {};
...
const point3 = new Particle(cp.x, cp.y, 0, 0);
...
function render() {
  ...
  context.quadraticCurveTo(cp.x, cp.y, p2.x, p2.y); // p1だったところをcpに変更
  context.stroke();
