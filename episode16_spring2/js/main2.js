...
class Particle {
  constructor(x, y, speed, direction, grav) {
    ...
    this.springLength = 100; // 重りと目標到達地点の距離
  ...
  move() {
    this.velocity.multiplyBy(this.friction); //摩擦
    this.velocity.addTo(this.gravity); // 重力
    this.position.addTo(this.velocity); // 新しい位置
  }
  ...
  spring() {
    ...
    // オフセット値をひく=>新しい距離
    this.distance.setLength(this.distance.getLength() - this.springLength);
